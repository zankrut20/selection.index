 #' @title Construction of selection indices (filtered/combinatorial)
 #'
 #' @description
 #' Build all possible selection indices from trait combinations, with optional
 #' exclusion of specific traits (by index, name, or data columns).
 #'
 #' @rdname lpsi
