...
- selection_intensity:
  ...
  Selection intensity constant (default: 2.063 for 10

  GAYOptional. Genetic advance of comparative trait for PRE calculation
...
w'g.This is the foundational selection index method from Chapter 2.
**Mathematical Formulation (Chapter 2):**Index coefficients: \\b =
P^{-1}Gw\\Where: - P = Phenotypic variance-covariance matrix - G =
Genotypic variance-covariance matrix - w = Economic weightsKey
metrics: - Variance of index: \\\sigma^2_I = b'Pb\\ - Total genetic
