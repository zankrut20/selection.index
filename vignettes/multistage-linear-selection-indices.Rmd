...
description: >
  Multistage linear selection indices (MLPSI, MRLPSI, MPPG-LPSI, MLGSI,
  MRLGSI, MPPG-LGSI) for sequential multi-environment plant breeding programs.
  Adjust phenotypic and genomic covariance matrices for prior selection with
  the Cochran-Cunningham method using the selection.index R package.
