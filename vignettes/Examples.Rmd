...
```{r}
si_ew<- comb.indices(ncomb = 2, phen_mat = pmat, gen_mat = gmat, weight_mat = wmat, weight_col = 1, GAY = 1.7694)
si_ew
```
```{r}
si_h2<- comb.indices(ncomb = 2, phen_mat = pmat, gen_mat = gmat, weight_mat = wmat, weight_col = 2, GAY = 1.7694)
si_h2
```
