...
description: >
  Linear Genomic Selection Index (LGSI) and Combined LGSI (CLGSI) for
  plant breeding using genomic estimated breeding values (GEBVs). Covers
  mathematical theory, GEBV computation via ridge regression, cycle-length
  efficiency, and R implementation with the selection.index package.
