---
title: "Linear Marker and Genome-Wide Selection Indices"
description: >
  Marker-assisted selection in plant breeding using the Linear Marker Selection
  Index (LMSI) and Genome-Wide LMSI (GW-LMSI). Covers calculation of marker
  scores, ridge regression, and combining phenotypic and SNP marker data to
  maximize genetic advance in the selection.index R package.
Author: "Zankrut Goyani"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Linear Marker and Genome-Wide Selection Indices}
...
$$ \mathbf{s}_i=\sum \limits_{j=1}^M \boldsymbol{\theta}_j \mathbf{x}_j $$
